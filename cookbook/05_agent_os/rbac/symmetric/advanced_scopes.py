...
if __name__ == "__main__":
    ...
    print('curl -H "Authorization: Bearer ' + power_user_token + '" http://localhost:7777/agents')
    print(
    ...
    print('curl -H "Authorization: Bearer ' + limited_user_token + '" http://localhost:7777/agents')
    print(
    ...
    print('curl -H "Authorization: Bearer ' + readonly_user_token + '" http://localhost:7777/agents')
    print(
    ...
    print('curl -H "Authorization: Bearer ' + wildcard_user_token + '" http://localhost:7777/agents')
    print(
