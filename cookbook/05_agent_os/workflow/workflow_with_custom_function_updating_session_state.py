...
def custom_content_planning_function(step_input: StepInput, run_context: RunContext) -> StepOutput:
    ...
    run_context.session_state["content_planning"]["topics_processed"].append(str(message))
    ...
    try:
        ...
        run_context.session_state["content_planning"]["planning_history"].append(planning_result)
