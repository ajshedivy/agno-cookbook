...
def custom_content_planning_function(step_input: StepInput) -> StepOutput:
    ...
    try:
        ...
        return StepOutput(content=f"Custom content planning failed: {str(exc)}", success=False)
...
async def streaming_custom_content_planning_function(
    ...
    try:
        ...
        yield StepOutput(content=f"Custom content planning failed: {str(exc)}", success=False)
...
agent_os = AgentOS(
    ...
    workflows=[streaming_content_creation_workflow if USE_STREAMING_WORKFLOW else sync_content_creation_workflow],
)
