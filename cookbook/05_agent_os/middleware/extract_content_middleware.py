...
class ContentExtractionMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        is_runs_endpoint = request.method == "POST" and request.url.path.endswith("/runs")
                        ...
                        for line in chunk_text.split("\n"):
                            if line.startswith("data: "):
                                try:
                                    ...
                                    if "content" in data and data["content"] and data["event"] == "RunContent":
    ...
    def _send_notification(self, app_uuid: str, response_body: str, is_streaming: bool = False):
