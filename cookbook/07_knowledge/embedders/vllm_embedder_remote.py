...
def create_knowledge(embedder: VLLMEmbedder, table_name: str, knowledge_table: str) -> Knowledge:
    return Knowledge(
        vector_db=PgVector(
...
async def run_variant(enable_batch: bool = False) -> None:
    ...
    table_name = "vllm_embeddings_minilm_batch_remote" if enable_batch else "vllm_embeddings_minilm_remote"
    knowledge_table = "vllm_batch_remote_knowledge" if enable_batch else "vllm_remote_knowledge"
