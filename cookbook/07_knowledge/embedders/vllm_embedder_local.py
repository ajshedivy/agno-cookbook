...
async def run_variant(enable_batch: bool = False) -> None:
    ...
    table_name = "vllm_embeddings_minilm_batch_local" if enable_batch else "vllm_embeddings_minilm_local"
    knowledge_table = "vllm_batch_local_knowledge" if enable_batch else "vllm_local_knowledge"
