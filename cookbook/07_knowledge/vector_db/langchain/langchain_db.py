...
state_of_the_union = pathlib.Path("cookbook/07_knowledge/testing_resources/state_of_the_union.txt")
...
def create_knowledge() -> Knowledge:
    ...
    return Knowledge(vector_db=LangChainVectorDb(knowledge_retriever=knowledge_retriever))
