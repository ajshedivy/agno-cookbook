...
class Task(BaseModel):
    ...
    assigned_to: Optional[UserProfile] = Field(None, description="User assigned to the task")
...
if __name__ == "__main__":
    ...
    agent.print_response("Create a high priority task titled 'Implement API endpoints' due tomorrow")
