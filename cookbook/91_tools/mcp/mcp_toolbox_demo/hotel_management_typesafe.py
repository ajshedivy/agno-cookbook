...
class Hotel(BaseModel):
    ...
    booked: str = Field(description="Indicates if the hotel is booked (bit field from database)")
...
class HotelSearchResult(BaseModel):
    hotels: List[Hotel] = Field(description="List of hotels matching the search criteria")
