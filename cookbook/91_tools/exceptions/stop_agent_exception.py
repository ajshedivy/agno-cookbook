...
def add_item(run_context: RunContext, item: str) -> str:
    ...
    logger.info(f"The shopping list is now: {run_context.session_state.get('shopping_list')}")  # type: ignore
...
if __name__ == "__main__":
    ...
    print(f"Final session state: {agent.get_session_state(session_id='stop_agent_exception_session')}")
