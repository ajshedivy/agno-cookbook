...
def post_hook(run_context: RunContext, fc: FunctionCall):
    ...
    shopping_list = run_context.session_state.get("shopping_list", []) if run_context.session_state else []
...
if __name__ == "__main__":
    ...
    print(f"Final session state: {agent.get_session_state(session_id='retry_tool_call_from_post_hook_session')}")
