...
def basic_text_extraction():
    ...
    agent.print_response("Please extract and summarize the main content from https://github.com/agno-agi/agno")
...
def language_specific_extraction():
    ...
    agent.print_response("Extract English content from https://www.reddit.com/r/MachineLearning/ and provide a summary")
...
def website_crawling():
    ...
    agent.print_response("Crawl https://example.com and extract content from up to 5 internal pages")
...
def multiple_urls_different_configs():
    ...
    news_agent.print_response("Extract and summarize this news article: https://techcrunch.com")
