...
if __name__ == "__main__":
    ...
    agent.print_response("Search for 'language models' and recent developments", markdown=True)

    context_agent.print_response("Get detailed context about artificial intelligence trends", markdown=True)
