...
if __name__ == "__main__":
    ...
    print(f"UserProfileStore exists: {lm.user_profile_store is not None if lm else False}")
    print(f"UserMemoryStore exists: {lm.user_memory_store is not None if lm else False}")
