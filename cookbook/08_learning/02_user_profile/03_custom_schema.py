...
class DeveloperProfile(UserProfile):
    ...
    role: Optional[str] = field(default=None, metadata={"description": "Job title (e.g., Senior Engineer)"})
    primary_language: Optional[str] = field(default=None, metadata={"description": "Main programming language"})
    languages: Optional[list[str]] = field(
        default=None, metadata={"description": "All programming languages they know"}
    )
    frameworks: Optional[list[str]] = field(default=None, metadata={"description": "Frameworks and libraries they use"})
    experience_years: Optional[int] = field(default=None, metadata={"description": "Years of programming experience"})
...
if __name__ == "__main__":
    ...
    agent.print_response(
        "Hi! I'm Alex Chen, a senior backend engineer at Stripe. I've been coding for about 12 years now.",
        user_id=user_id,
        session_id="conv_1",
        stream=True,
    )
