...
if __name__ == "__main__":
    ...
    print("\n--- Entities ---")
    pprint(agent.learning_machine.entity_memory_store.search(query="techcorp", limit=10))
    ...
    agent.print_response(
        "TechCorp just acquired StartupAI for $50M. They also partnered with CloudCo on infrastructure.",
        user_id=user_id,
