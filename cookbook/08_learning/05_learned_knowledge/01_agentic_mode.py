...
if __name__ == "__main__":
    ...
    agent.print_response(
        "Save this: For database migrations, always test rollback procedures in staging before running in production.",
        user_id=user_id,
    ...
    agent.print_response(
        "I'm setting up a new project with PostgreSQL on AWS. What best practices should I follow?",
        user_id=user_id,
