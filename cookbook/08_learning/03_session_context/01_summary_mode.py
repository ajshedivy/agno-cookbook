...
if __name__ == "__main__":
    ...
    agent.print_response(
        "I'm debugging a memory leak in my Python FastAPI server. It processes large JSON payloads.",
        user_id=user_id,
    ...
    agent.print_response(
        "The memory grows even when there's no traffic. I've checked for unclosed file handles already.",
        user_id=user_id,
        session_id=session_id,
        stream=True,
    )
