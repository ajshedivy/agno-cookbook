...
# Create Agents
# ---------------------------------------------------------------------------
step_a = Agent(name="step_a", model=model, instructions="Step A")
step_b = Agent(name="step_b", model=model, instructions="Step B")
step_c = Agent(name="step_c", model=model, instructions="Step C")
