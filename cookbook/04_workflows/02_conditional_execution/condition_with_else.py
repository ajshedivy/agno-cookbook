...
if __name__ == "__main__":
    ...
    print("=" * 60)
    workflow.print_response("My app keeps crashing with a timeout error after the latest update")
    ...
    print("=" * 60)
    asyncio.run(workflow.aprint_response("My app keeps crashing with a timeout error after the latest update"))

    print()
    print("=" * 60)
    print("Async General Query")
    print("=" * 60)
    asyncio.run(workflow_2.aprint_response("How do I change my shipping address for order #12345?"))
