...
def research_evaluator(outputs: List[StepOutput]) -> bool:
    ...
    if total_content_length > 500:
        print(f"[PASS] Research evaluation passed - found substantial content ({total_content_length} chars total)")
        return True

    print(f"[FAIL] Research evaluation failed - need more substantial research (current: {total_content_length} chars)")
    return False
