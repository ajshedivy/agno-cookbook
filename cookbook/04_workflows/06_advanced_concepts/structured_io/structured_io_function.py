    ...
    if previous_step_content:
        ...
        try:
            ...
            if hasattr(previous_step_content, "topic"):
                analysis_results.append(f"[PASS] Research Topic: {previous_step_content.topic}")
            if hasattr(previous_step_content, "confidence_score"):
                analysis_results.append(f"[PASS] Confidence Score: {previous_step_content.confidence_score}")
