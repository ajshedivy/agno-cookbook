...
try:
    ...
    raise ImportError("OpenAI agents not installed. Please install it using `uv pip install openai-agents`.")
...
# Create Evaluation
# ---------------------------------------------------------------------------
openai_agents_instantiation = PerformanceEval(func=instantiate_agent, num_iterations=1000)
