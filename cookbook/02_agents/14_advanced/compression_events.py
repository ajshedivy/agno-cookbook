...
async def main():
    ...
    async for chunk in stream:
        if chunk.event == RunEvent.run_started.value:
            ...
            print(f"[CompressionCompleted] compressed={chunk.tool_results_compressed} results")
            print(f"  Original: {chunk.original_size} chars -> Compressed: {chunk.compressed_size} chars")
