...
if __name__ == "__main__":
    ...
    for requirement in run_response.active_requirements:
        if requirement.needs_user_input:
            print(f"  Providing user input for tool: {requirement.tool_execution.tool_name}")
    ...
    assert approval_record["status"] == "approved", f"Expected 'approved', got {approval_record['status']}"
    assert approval_record["approval_type"] == "audit", f"Expected 'audit', got {approval_record['approval_type']}"
