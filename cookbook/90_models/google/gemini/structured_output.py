...
class EventSchema(BaseModel):
    ...
    budget_range: Union[float, str] = Field(description="Budget as number (USD) or 'TBD' if not determined")
    ...
    contact_info: ContactInfo = Field(description="Contact information with structured properties")
...
if __name__ == "__main__":
    # --- Sync ---
    structured_output_agent.print_response("Plan a corporate product launch event for 150 people next month")
