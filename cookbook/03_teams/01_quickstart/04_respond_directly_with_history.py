...
geo_search_team = Team(
    ...
    db=SqliteDb(db_file="tmp/geo_search_team.db"),  # Add a database to store the conversation history
...
if __name__ == "__main__":
    geo_search_team.print_response("I am doing research on Tokyo. What is the weather like there?", stream=True)

    geo_search_team.print_response("Is there any current news about that city?", stream=True)
