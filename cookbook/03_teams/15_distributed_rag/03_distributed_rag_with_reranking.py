...
async def async_reranking_rag_demo() -> None:
    ...
    await reranked_knowledge.ainsert_many(url="https://agno-public.s3.amazonaws.com/recipes/ThaiRecipes.pdf")
    await validation_knowledge.ainsert_many(url="https://agno-public.s3.amazonaws.com/recipes/ThaiRecipes.pdf")
...
def sync_reranking_rag_demo() -> None:
    ...
    reranked_knowledge.insert_many(url="https://agno-public.s3.amazonaws.com/recipes/ThaiRecipes.pdf")
    validation_knowledge.insert_many(url="https://agno-public.s3.amazonaws.com/recipes/ThaiRecipes.pdf")
