...
knowledge_primary = Knowledge(
    vector_db=LanceDb(
        ...
        reranker=InfinityReranker(base_url="http://localhost:7997/rerank", model="BAAI/bge-reranker-base"),
    ),
)
...
async def async_distributed_search() -> None:
    ...
    await knowledge_primary.ainsert_many(urls=["https://docs.agno.com/agents/overview.md"])
    await knowledge_secondary.ainsert_many(urls=["https://docs.agno.com/agents/overview.md"])
