...
@tool
def calculate_compound_interest(principal: float, annual_rate: float, years: int, compounds_per_year: int = 12) -> str:
...
@tool
def assess_risk_score(debt_to_income_ratio: float, credit_score: int, years_employed: int) -> str:
