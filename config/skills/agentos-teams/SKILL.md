...
description: |
  ...
  Covers listing teams, running teams (streaming and non-streaming), and
  cancelling team runs. Trigger this skill when: running teams via the
  API, using run_team or run_team_stream, discovering available teams,
  or asking "how do I run a team through the API?"
license: Apache-2.0
metadata:
  version: "1.0.0"
  author: agno-team
