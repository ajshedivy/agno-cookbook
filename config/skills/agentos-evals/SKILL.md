...
description: |
  ...
  Covers running accuracy and performance evaluations, listing eval runs,
  getting eval details, and managing evaluations. Trigger this skill when:
  running evaluations via the API, using run_eval or list_eval_runs,
  or asking "how do I evaluate an agent through the API?"
license: Apache-2.0
metadata:
  version: "1.0.0"
  author: agno-team
