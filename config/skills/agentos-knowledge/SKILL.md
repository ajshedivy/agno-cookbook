...
description: |
  ...
  Covers uploading content, searching the knowledge base, listing and
  deleting content, checking content status, and getting config. Trigger
  this skill when: managing knowledge base content via the API, uploading
  documents, searching knowledge, or asking "how do I upload content to
